...
public class Segment {
  ...
  public boolean hitten(Point p) {
    return new Rectangle(pos.x * segmentSize, pos.y * segmentSize, segmentSize, segmentSize)
        .contains(p);
  }
  ...
  public void paint(Graphics g) {
    if (!isEmpty) {
      ...
      g.drawLine(
          pos.x * segmentSize + (segmentSize - 1),
          pos.y * segmentSize,
          pos.x * segmentSize + (segmentSize - 1),
          (pos.y + 1) * segmentSize);
      g.drawLine(
          pos.x * segmentSize,
          pos.y * segmentSize + (segmentSize - 1),
          (pos.x + 1) * segmentSize,
          pos.y * segmentSize + (segmentSize - 1));
      g.setColor(new Color(150, 150, 150, 100));
      g.drawLine(
          pos.x * segmentSize, pos.y * segmentSize, pos.x * segmentSize, (pos.y + 1) * segmentSize);
      g.drawLine(
          pos.x * segmentSize, pos.y * segmentSize, (pos.x + 1) * segmentSize, pos.y * segmentSize);
    }
  }
